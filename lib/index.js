...
ServiceProvider.prototype.produceSPMetadata = function() {
	return metadata.buildSPMetadata(this.sp, true);
}
...
IdentityProvider.prototype.produceFailureResponse = function(sp, inResponseTo, errorMessage) {
	return responseConstruction.buildBoundFailureResponse(sp, this.idp, this.model, inResponseTo, errorMessage);
}

IdentityProvider.prototype.produceIDPMetadata = function() {
	return metadata.buildIDPMetadata(this.idp, true);
}
