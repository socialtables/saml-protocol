...
import { buildSPMetadata, getIDPFromMetadata, buildIDPMetadata, getSPFromMetadata } from './metadata';
...
class ServiceProvider {
  ...
  produceAuthnRequest(idp) {
    return createBoundAuthnRequest(this.sp, idp, this.model);
  }
