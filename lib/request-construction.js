 ...
 */
async function createBoundAuthnRequest(sp, idp, model) {
      ...
      'samlp:AuthnRequest': [ // request child elements are ordered
        {
          ...
          '@IsPassive': sp.forcePassive,
          '@ForceAuthn': sp.forceAuthentication,
        },
        ...
        (sp.sendAuthnContext ? {
          'samlp:RequestedAuthnContext': [
            {
              '@Comparison': sp.authnContextClassComparison,
            },
            ...sp.authnContextClasses.map(ac => ({ 'saml:AuthnContextClassRef': ac })),
          ],
        } : null),
